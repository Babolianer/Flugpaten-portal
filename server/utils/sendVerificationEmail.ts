...
<head>
  ...
  <title>E-Mail bestätigen – PawBridge</title>
</head>
<body style="margin: 0; padding: 20px; font-family: system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #1e293b; font-size: 15px;">
  <div style="max-width: 580px; margin: 0 auto;">
    ...
    <p style="margin: 0 0 1em 0;">vielen Dank für deine Registrierung bei PawBridge. Bitte bestätige deine E-Mail-Adresse, um Flugpate zu werden.</p>
    ...
    <p style="margin: 2em 0 0 0; padding-top: 12px; border-top: 1px solid #e2e8f0; font-size: 12px; color: #64748b;">PawBridge – Flugpaten-Portal</p>
  </div>
</body>
</html>`
  ...
  const { error } = await resend.emails.send({
    from,
    to,
    subject: 'PawBridge: E-Mail-Adresse bestätigen',
    html,
  })
